...
int main()
{
	sfw::initContext(WINDOW_WIDTH, WINDOW_HEIGHT, "Metroid Invaders!");

	//initialization
	spriteEnemy = sfw::loadTextureMap("./textures/metroid.jpg");
	spriteParticle = sfw::loadTextureMap("./textures/particle.png");
	spritePlayer = sfw::loadTextureMap("./textures/ship.png");
	spriteSpace = sfw::loadTextureMap("./textures/space background.jpg");
